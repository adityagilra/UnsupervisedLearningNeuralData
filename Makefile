...
$(TARGET).so: $(TARGET).o
	g++ -shared -Wl,--export-dynamic $(TARGET).o BasinModel.o TreeBasin.o -L$(BOOST_LIB) -lgsl -lgslcblas -lboost_python -lboost_numpy27  -L$(PYTHON_LIB_CONFIG) -lpython$(PYTHON_VERSION) -o $(TARGET).so
